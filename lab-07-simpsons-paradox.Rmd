...
***There are r'ncol(Whickham)' variables in the dataset.
Both 'Outcome' and 'Smoker' are character data than are 2 level factors and 'age' is numerical data.
***
...
***I expect smokers to be more likely to be dead.***
